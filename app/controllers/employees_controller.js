...
const { getEmployees, getDetailEmployee, createEmployee, updateEmployee, deleteEmployee } = require('../../domain/usecase/employees-usecase');
...
const updateEmployeesFn = async(data, id) => {
    let response = null;
    try {
